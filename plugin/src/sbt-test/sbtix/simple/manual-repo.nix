# this file must still be generated manually.  
{
  ...
  "artifacts" = {
    ...
    "nix-public/org/apache/ant/ant-parent/1.9.6/ant-parent-1.9.6.pom" = {
      url = "https://repo1.maven.org/maven2/org/apache/ant/ant-parent/1.9.6/ant-parent-1.9.6.pom";
      sha256 = "0zrdyf1j1z9g4d04y6icpmh1r7ymk0n5lgwr61vc4740aayihbq5";
    };
    ...
    "nix-public/org/slf4j/slf4j-parent/1.7.10/slf4j-parent-1.7.10.pom" = {
      url = "https://repo1.maven.org/maven2/org/slf4j/slf4j-parent/1.7.10/slf4j-parent-1.7.10.pom";
